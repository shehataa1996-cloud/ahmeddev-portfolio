...
// إضافة رؤوس الحماية (Content-Security-Policy) لتفعيل Trusted Types
app.use((req, res, next) => {
    // تم تفعيل تطلب الأنواع الموثوقة وتحديد سياسة افتراضية باسم 'default'
    res.setHeader("Content-Security-Policy", "require-trusted-types-for 'script'; trusted-types default;");
    next();
});
